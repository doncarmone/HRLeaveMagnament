...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20231021220122_InitialMigration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 10, 21, 16, 1, 22, 643, DateTimeKind.Local).AddTicks(9340),
                            DateModified = new DateTime(2023, 10, 21, 16, 1, 22, 643, DateTimeKind.Local).AddTicks(9370),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
